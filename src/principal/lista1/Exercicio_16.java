...
public class Exercicio_16 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Programa que converte valor de polegadas em centímetros");
			...
			do{
				...
				if(digitacao.hasNextDouble()){ 
					...
					if(numeroReal < 0) {
			    		...
			    		System.out.println("O valor de " + formatter.format(numeroReal) +" polegadas equivale a " + formatter.format(numeroReal * 2.54) + " centímetros.");
			    		verificacao = true;
					}
