...
public class Exercicio_18 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Programa que lê um valor em metros cúbicos (m³) e converte em litros.");
		  
	    try (Scanner digitacao = new Scanner(System.in)) {
			// Loop com verificação no final:
			boolean verificacao = false; 
			do{
				System.out.print("Digite um valor em metros cúbicos (m³): ");
				if(digitacao.hasNextDouble()){ 
					...
					if(numeroReal < 0) {
			    		...
			    		System.out.println("O valor de " + formatter.format(numeroReal) +"m³ equivale a " + formatter.format(numeroReal * 1000) + " litros.");
			    		verificacao = true;
					}
