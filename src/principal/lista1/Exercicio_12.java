...
public class Exercicio_12 {
	...
	public static void main(String[] args) {
		System.out.println("Programa que converte a distância de milhas para Km");
			...
			do{
				...
				if(digitacao.hasNextDouble()){ 
					...
					if(numeroReal < 0) {
			    		...
			    		System.out.println("A distância de " + formatter.format(numeroReal) +" milhas equivale a " + formatter.format(numeroReal * 1.61) + " km.");
			    		verificacao = true;
					}
