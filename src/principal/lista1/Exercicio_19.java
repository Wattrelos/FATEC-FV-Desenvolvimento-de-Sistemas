...
public class Exercicio_19 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Programa que lê um valor em litros e converte em metros cúbicos (m³).");
			...
			do{
				...
				if(digitacao.hasNextDouble()){ 
					...
					if(numeroReal < 0) {
			    		...
			    		System.out.println("O valor de " + formatter.format(numeroReal) +"litros equivale a " + formatter.format(numeroReal * 0.001) + " m³.");
			    		verificacao = true;
					}
