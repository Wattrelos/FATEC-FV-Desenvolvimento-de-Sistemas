...
public class Lista02_exercicio04 {
		...
		public static void main(String[] args) {
			System.out.println("Programa que lê um número e, caso ele seja positivo, calcula e mostra o número digitado ao quadrado, se não, mostra a raiz quadrada.");
		    ...
		    try (Scanner digitacao = new Scanner(System.in)) {
				...
				System.out.println("\nO número " + formatter.format(number) + "² = " + formatter.format(Math.pow(number,2)));
